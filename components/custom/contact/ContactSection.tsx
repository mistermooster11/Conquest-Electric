        ...
        <div className="contact-section__info">
          ...
          <div className="contact-section__details">
            ...
            <div className="contact-section__details-col">
              <h5 className="contact-detail__label">Service Area</h5>
              <p className="contact-detail__value">
                Manhattan, Brooklyn, The Bronx, Queens, Staten Island &amp;&nbsp;New&nbsp;Jersey
              </p>

              <h5 className="contact-detail__label">Follow us</h5>
              <div className="contact-section__social">
                <Link href="https://www.instagram.com/conquestelectric/" className="contact-social-icon" aria-label="Instagram" target="_blank" rel="noopener noreferrer">
            ...
            <div className="contact-section__details-col">
              ...
              <p className="contact-detail__value">
                <Link href="tel:2123016225">212-301-6225</Link>
              </p>

              <h5 className="contact-detail__label">Email</h5>
              <p className="contact-detail__value">
                <Link href="mailto:service@conquestelectric.com">service@conquestelectric.com</Link>
              </p>
            </div>
