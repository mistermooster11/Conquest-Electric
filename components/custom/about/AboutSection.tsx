      ...
      <div className="about__container">
        ...
        <div className="about__content">
          ...
          <h2 className="about__heading">
            Trusted electrical contractor serving New York City &amp; New Jersey
          </h2>
          <p className="about__text">
            Conquest Electric is a 5-star electrical contractor with a team of
            highly skilled licensed electricians serving Manhattan, New York City,
            New Jersey, and surrounding areas.
          </p>
          <p className="about__text">
            We offer a broad range of services — from free consultations and new
            installations to repairs, troubleshooting, EV charging, and emergency
            service. One call, one team, every electrical need covered.
          </p>
        ...
        <div className="about__media">
          <div className="about__img-wrap">
            <Image
              ...
              alt="Conquest Electric licensed electrician at work"
              width={690}
              height={613}
