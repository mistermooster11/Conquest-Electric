  ...
  return (
    <section className="pricing" ref={sectionRef}>
      ...
      <div className="pricing__header">
        ...
        <h2 className="pricing__heading">Free Estimates — No Hidden Fees</h2>
        <p className="pricing__subtext">
          We provide upfront quotes for all residential and commercial electrical work
          before any job begins — pricing is exactly as discussed, every time.
          Call 212-301-6225 for a free consultation.
        </p>
      </div>
