...
const BENEFITS = [
  ...
  },
  {
    num: "04",
    title: "Grow With Us",
    text: "Join a fast-growing company expanding across New York City and New Jersey with room to advance.",
  },
];
    ...
    <section className="become-section" ref={sectionRef}>
      <div className="become-section__inner">
        <p className="become-section__intro">
          Conquest Electric is expanding its team of licensed electricians across New York City and New Jersey.
