    ...
    <section className="services" ref={sectionRef}>
      ...
      <div className="services__header max-w-6xl! mx-auto">
        ...
        <h2 className="services__heading">
          Licensed Electrical Services in New York City &amp; New Jersey
        </h2>
        <p className="services__subtext">
          Reliable residential and commercial electrical services designed to keep your property
          safe, up to code, and running smoothly — from Manhattan apartments to NJ commercial spaces.
        </p>
      </div>
