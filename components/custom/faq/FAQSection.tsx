      ...
      <div className="faq__container">
        ...
        <div className="faq__left">
          ...
          <h2 className="faq__heading">
            Frequently Asked Questions About Our Electrical Services in NYC &amp; NJ
          </h2>
          <p className="faq__subtext">
            Find clear answers about our residential and commercial electrical services,
            panel upgrades, EV charger installations, and emergency response across
