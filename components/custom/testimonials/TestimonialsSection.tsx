    ...
    <section className="testimonials" ref={sectionRef}>
      <div className="testimonials__container">
        ...
        <div className="testimonials__header">
          <div className="testimonials__eyebrow">5-Star Rated</div>
          <h2 className="testimonials__heading">What New Yorkers Say About Us</h2>
          <p className="testimonials__subtext">
            Our clients rely on Conquest Electric for fast response, honest pricing, and clean
            electrical work — across Manhattan, Brooklyn, and all of New York City.
          </p>
        </div>
